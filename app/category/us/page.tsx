...
export default function Page() {
  ...
  const supplierMeta: SupplierMeta[] = [
    { supplier: "Barilla USA Inc",       category: "Grocery", cm: "Iryna Zender" },
    { supplier: "American Pasta Co",     category: "Grocery", cm: "Iryna Zender" },
    { supplier: "Pacific Coast Seafood", category: "Protein", cm: "Denys Lauster + Victoria Radford" },
    { supplier: "Atlantic Fresh Corp",   category: "Protein", cm: "Denys Lauster + Victoria Radford" },
  ];
    ...
    <div style={{ background: "#F8F8F8", minHeight: "100vh", padding: "32px 24px", fontFamily: "var(--font-body)" }}>
      <div style={{ maxWidth: 960, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 20, font: "400 13px/18px var(--font-body)", color: "#676767" }}>
          ...
          <span>/</span>
          <span style={{ color: "#242424", fontWeight: 600 }}>US</span>
        </div>

        {/* Page header */}
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: 28, flexWrap: "wrap", gap: 12 }}>
          <div>
            <h1 style={{ font: "700 28px/36px var(--font-display)", color: "#242424", margin: 0 }}>US Category Management</h1>
        ...
        {/* No Bakery notice */}
        <div style={{ background: "#FAFAFA", border: "1px solid #E4E4E4", borderRadius: 10, padding: "12px 16px", marginBottom: 20, font: "400 13px/18px var(--font-body)", color: "#676767", display: "flex", alignItems: "center", gap: 8 }}>
          <span>ℹ️</span>
          No Bakery contracts active in the US market for this contract period.
        </div>
        ...
        <div style={{ display: "flex", gap: 14, flexWrap: "wrap", marginBottom: 28 }}>
          ...
          <KpiCard label="Budget Utilisation" value={`${metrics.budgetUtilizationPct}%`} sub={metrics.budgetUtilizationPct >= 90 ? "⚠ High risk" : metrics.budgetUtilizationPct >= 75 ? "Monitor closely" : "On track"} tone={metrics.budgetUtilizationPct >= 90 ? "danger" : metrics.budgetUtilizationPct >= 75 ? "warning" : "positive"} />
        ...
        <div style={{ marginBottom: 28 }}>
          ...
          <CmSection name="Iryna Zender"     suppliers={["Barilla USA Inc", "American Pasta Co"]}         rows={marketRows} marketLabel={MARKET} />
          <CmSection name="Denys Lauster"    suppliers={["Pacific Coast Seafood", "Atlantic Fresh Corp"]} rows={marketRows} marketLabel={MARKET} />
          <CmSection name="Victoria Radford" suppliers={["Pacific Coast Seafood", "Atlantic Fresh Corp"]} rows={marketRows} marketLabel={MARKET} />
        </div>
